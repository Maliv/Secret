...
local function run(msg, matches)
  if matches[1]:lower() == 'secret' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "secret" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) ([Se]ecret)",-- Put everything you like :)
		"^[!/](secret)"-- Put everything you like :)
    }, 
  run = run
}
